...
| Child sees `Back to your app` guidance and manually reopens the now-unshielded content app/site | Pass / Fail |  |
...
| Child solves the challenge, sees `Back to your app`, and manually reopens the unlocked app/site | Pass / Fail / N/A |  |
