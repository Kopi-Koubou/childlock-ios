...
| Child sees `Ready to go back` guidance and manually reopens the now-unshielded content app/site | Pass / Fail |  |
...
| Child solves the challenge, sees `Ready to go back`, taps the cue, and manually reopens the unlocked app/site | Pass / Fail / N/A |  |
