...
| Child sees `Press Home now` guidance and manually reopens the now-unshielded content app/site | Pass / Fail |  |
...
| Child solves the challenge, sees `Press Home now`, and manually reopens the unlocked app/site | Pass / Fail / N/A |  |
