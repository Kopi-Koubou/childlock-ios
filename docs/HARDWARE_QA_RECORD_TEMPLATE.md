...
| Child sees `Back to app` guidance and returns to the now-unshielded content app/site | Pass / Fail |  |
...
| Child solves the challenge, sees `Back to app`, and returns to the unlocked app/site | Pass / Fail / N/A |  |
