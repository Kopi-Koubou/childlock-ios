...
echo "7. Verify: Start keeps the shielded app in place and Childlock opens the pending challenge from the alert."
echo "8. Verify: challenge completion clears shields and re-arms monitoring."
echo "9. Verify: hand-back shows Great job plus the Swipe back cue, returns to the previous app, and keeps the parent dashboard behind the PIN."
echo ""
