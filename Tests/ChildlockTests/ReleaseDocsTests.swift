...
final class ReleaseDocsTests: XCTestCase {
    ...
    func testTestFlightChecklistCapturesLaunchGateEvidence() throws {
        ...
        XCTAssertTrue(checklist.contains("| Child saw `Swipe up` guidance and returned to the now-unshielded content app/site | Pass / Fail |"))
        ...
        XCTAssertTrue(checklist.contains("Child solves the challenge, sees `Swipe up`"))
        ...
        XCTAssertTrue(template.contains("Child sees `Swipe up` guidance and returns to the now-unshielded content app/site"))
        ...
        XCTAssertTrue(template.contains("Child solves the challenge, sees `Swipe up`, and returns to the unlocked app/site"))
