...
final class ReleaseDocsTests: XCTestCase {
    ...
    func testTestFlightChecklistCapturesLaunchGateEvidence() throws {
        ...
        XCTAssertTrue(checklist.contains("| Child saw `Press Home now` guidance and manually reopened the now-unshielded content app/site | Pass / Fail |"))
        ...
        XCTAssertTrue(checklist.contains("Child solves the challenge, sees `Press Home now`"))
        ...
        XCTAssertTrue(template.contains("Child sees `Press Home now` guidance and manually reopens the now-unshielded content app/site"))
        ...
        XCTAssertTrue(template.contains("Child solves the challenge, sees `Press Home now`, and manually reopens the unlocked app/site"))
