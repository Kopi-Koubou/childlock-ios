...
final class ReleaseDocsTests: XCTestCase {
    ...
    func testTestFlightChecklistCapturesLaunchGateEvidence() throws {
        ...
        XCTAssertTrue(checklist.contains("| Child saw `Ready to go back` guidance and manually reopened the now-unshielded content app/site | Pass / Fail |"))
        ...
        XCTAssertTrue(checklist.contains("Child solves the challenge, sees `Ready to go back`"))
        ...
        XCTAssertTrue(template.contains("Child sees `Ready to go back` guidance and manually reopens the now-unshielded content app/site"))
        ...
        XCTAssertTrue(template.contains("Child solves the challenge, sees `Ready to go back`, taps the cue, and manually reopens the unlocked app/site"))
