...
final class ReleaseDocsTests: XCTestCase {
    ...
    func testTestFlightChecklistCapturesLaunchGateEvidence() throws {
        ...
        XCTAssertTrue(checklist.contains("| Child saw `Back to app` guidance and returned to the now-unshielded content app/site | Pass / Fail |"))
        ...
        XCTAssertTrue(checklist.contains("Child solves the challenge, sees `Back to app`"))
        ...
        XCTAssertTrue(template.contains("Child sees `Back to app` guidance and returns to the now-unshielded content app/site"))
        ...
        XCTAssertTrue(template.contains("Child solves the challenge, sees `Back to app`, and returns to the unlocked app/site"))
