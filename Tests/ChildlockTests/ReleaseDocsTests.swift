...
final class ReleaseDocsTests: XCTestCase {
    ...
    func testTestFlightChecklistCapturesLaunchGateEvidence() throws {
        ...
        XCTAssertTrue(checklist.contains("| Child saw `Return to your app` guidance and manually reopened the now-unshielded content app/site | Pass / Fail |"))
        ...
        XCTAssertTrue(checklist.contains("Child solves the challenge, sees `Return to your app`"))
        ...
        XCTAssertTrue(template.contains("Child sees `Return to your app` guidance and manually reopens the now-unshielded content app/site"))
        ...
        XCTAssertTrue(template.contains("Child solves the challenge, sees `Return to your app`, and manually reopens the unlocked app/site"))
