...
final class ReleaseDocsTests: XCTestCase {
    ...
    func testTestFlightChecklistCapturesLaunchGateEvidence() throws {
        ...
        XCTAssertTrue(normalizedChecklist.contains("latest simulator QA gallery path"))
        ...
        XCTAssertTrue(checklist.contains("Do not edit this checklist only to chase a new\n  run ID"))
        XCTAssertTrue(checklist.contains("pre-fills the\n  newest generated simulator summary and gallery paths"))
        XCTAssertTrue(checklist.contains("A setup seed that falls back to the welcome screen\n  is not a valid pass"))
