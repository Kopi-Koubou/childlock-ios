...
final class BuildConfigTests: XCTestCase {
    ...
    func testBuildScriptsAreRepoRelativeAndSafeForUnsignedPreflight() throws {
        ...
        XCTAssertTrue(validationScript.contains("pending challenge from the alert"))
        XCTAssertTrue(validationScript.contains("hand-back shows Great job plus the Swipe back cue"))
        XCTAssertTrue(testFlightQAPacketScript.contains("sees Great job plus the Swipe back cue"))
