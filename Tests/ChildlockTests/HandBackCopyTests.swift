...
final class HandBackCopyTests: XCTestCase {
    func testHandBackKeepsChildInstructionPrimaryAndParentEntryVisible() throws {
        ...
        XCTAssertTrue(contents.contains("accessibilityLabel(\"Press Home now. Swipe up or press Home, then tap your video, game, or site.\")"))
    ...
    func testInteractiveControlsDoNotExposeInternalIDsAsSpokenLabels() throws {
        ...
        XCTAssertTrue(handBack.contains("accessibilityLabel(\"Press Home now. Swipe up or press Home"))
