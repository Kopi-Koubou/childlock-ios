...
final class HandBackCopyTests: XCTestCase {
    func testHandBackKeepsChildInstructionPrimaryAndParentEntryVisible() throws {
        ...
        XCTAssertTrue(contents.contains("Back to app"))
        ...
        XCTAssertTrue(contents.contains("accessibilityLabel(\"Back to app.\")"))
        ...
        XCTAssertTrue(contents.contains(".font(.system(size: 34, weight: .semibold, design: .rounded))"))
        ...
        XCTAssertTrue(contents.contains("Label(\"Parent\", systemImage: \"lock.fill\")"))
    ...
    func testInteractiveControlsDoNotExposeInternalIDsAsSpokenLabels() throws {
        ...
        XCTAssertTrue(handBack.contains("accessibilityLabel(\"Back to app.\")"))
