...
final class HandBackCopyTests: XCTestCase {
    func testHandBackKeepsChildInstructionPrimaryAndParentEntryVisible() throws {
        ...
        XCTAssertTrue(contents.contains("Return to your app"))
        XCTAssertTrue(contents.contains("Swipe up or press Home, then tap the same video, game, or site."))
        ...
        XCTAssertTrue(contents.contains("accessibilityLabel(\"Return to your app. Swipe up or press Home, then tap the same video, game, or site.\")"))
    ...
    func testInteractiveControlsDoNotExposeInternalIDsAsSpokenLabels() throws {
        ...
        XCTAssertTrue(handBack.contains("accessibilityLabel(\"Return to your app. Swipe up or press Home"))
