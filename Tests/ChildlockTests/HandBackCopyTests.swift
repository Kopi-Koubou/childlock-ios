...
final class HandBackCopyTests: XCTestCase {
    func testHandBackKeepsChildInstructionPrimaryAndParentEntryVisible() throws {
        ...
        XCTAssertTrue(contents.contains("HandBackResumeCue("))
        XCTAssertTrue(contents.contains("Ready to go back"))
        XCTAssertTrue(contents.contains("Tap here when you are ready for the last step."))
        XCTAssertTrue(contents.contains("Press Home now"))
        XCTAssertTrue(contents.contains("Swipe up or press Home, then tap your video, game, or site."))
        XCTAssertTrue(contents.contains("accessibilityIdentifier(\"handback_resume_action\")"))
        XCTAssertTrue(contents.contains("accessibilityLabel(didShowResumeStep ? \"Press Home now\" : \"Ready to go back\")"))
