...
final class HandBackCopyTests: XCTestCase {
    func testHandBackKeepsChildInstructionPrimaryAndParentEntryVisible() throws {
        ...
        XCTAssertTrue(contents.contains("You can go back now."))
        ...
        XCTAssertTrue(contents.contains("Swipe up"))
        XCTAssertTrue(contents.contains("Open your app."))
        ...
        XCTAssertTrue(contents.contains("accessibilityLabel(\"Swipe up. Open your app.\")"))
        ...
        XCTAssertTrue(contents.contains(".fixedSize(horizontal: false, vertical: true)"))
    ...
    func testInteractiveControlsDoNotExposeInternalIDsAsSpokenLabels() throws {
        ...
        XCTAssertTrue(handBack.contains("accessibilityLabel(\"Swipe up. Open your app.\")"))
