...
final class AuthRedirectConfigTests: XCTestCase {
    ...
    func testDebugLaunchSeedsStayDebugOnly() throws {
        ...
        XCTAssertTrue(rootView.contains("tab: arguments.contains(DebugLaunchArgument.appsTab) ? .apps : arguments.contains(DebugLaunchArgument.settingsTab) ? .settings : .home"))
